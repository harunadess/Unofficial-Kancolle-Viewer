 ...
 *
 * One-shot model:
 *  User: "Alexa, ask Unofficial Kancolle Helper how to make a destroyer."
 *  Alexa: "(reads back recipe for a destroyer)"
 */
...
/**
 * KancolleHelper is a child of AlexaSkill.
...
HowTo.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    var speechText = "Welcome to the Unofficial Kancolle Helper. You can ask a question like, what's the recipe for a destroyer? ... Now, what can I help you with?";
